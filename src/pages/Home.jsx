...
export default function Home() {
  ...
  return (
    ...
    <Desktop>
      <div id='home-desktop-layout'>
        
        <img className='home-avatar' src={myAvatar} alt='Hawk Avatar' />
        ...
        <div className='home-descriptors-container'>
          ...
          <div className='home-descriptor'>
            <svg width="100px" height="50px" viewBox="0 0 640 360">
              <path fill="#2c3e50" d="M5 15A10 10 0 0 1 15 5H115A10 10 0 0 1 125 15V225A25 25 0 0 0 150 250H245A25 25 0 0 0 265 230V155A25 25 0 0 0 245 135H140C130 100 175 100 180 70C185 35 220 35 225 20C230 10 230 5 240 5H360V250L265 355H135A135 130 0 0 1 5 225V15ZM370 5V345A10 10 0 0 0 380 355H465A10 10 0 0 0 475 345V155A25 25 0 0 1 490 135H525C535 135 535 125 540 115C555 85 580 105 590 75C605 40 635 60 635 5H370Z" />
            </svg>
